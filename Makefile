...
SRCS_FIL = \
			error.c init.c main.c parse_cub_utils.c parse_cub.c parse_map_utils.c parse_map.c utils.c validate_map_horizontal.c validate_map_vertical.c validate_map.c
			\
